...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="address" required  lay-verify="required" value="{{$data['address']}}" placeholder="请输入地址" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">命名空间</label>
        <div class="layui-input-block">
            <input type="text" name="space" required  lay-verify="required" value="{{$data['space']}}"  placeholder="请输入命名空间" autocomplete="off" class="layui-input">
        </div>
    </div>
